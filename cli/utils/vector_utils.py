...
class VectorDBClient:
    ...
    def __init__(self, base_url: Optional[str] = None):
        ...
        """
        self.base_url = base_url or os.environ.get("VECTOR_DB_URL", "http://localhost:8000")
    ...
    def query_documents(self, collection_name: str, query: str, top_k: int = 5) -> List[Dict[str, Any]]:
        """

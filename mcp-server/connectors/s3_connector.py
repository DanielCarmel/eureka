...
class S3Connector(BaseConnector):
    ...
    def _extract_text_from_object(self, bucket: str, key: str) -> str:
        ...
        try:
            ...
            elif ext in ['.doc', '.docx'] or 'application/vnd.openxmlformats-officedocument.wordprocessingml' in content_type:
    ...
    def get_document(self, document_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if len(parts) != 2:
                raise ValueError(f"Invalid S3 document ID format: {document_id}. Expected 'bucket/key'")
            ...
            document = {
                ...
                "last_modified": obj.last_modified.strftime('%Y-%m-%d %H:%M:%S') if hasattr(obj, 'last_modified') else '',
                "metadata": metadata
            }

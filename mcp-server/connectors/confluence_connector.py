...
class ConfluenceConnector(BaseConnector):
        ...
        try:
            ...
            for result in search_results.get('results', []):
                ...
                if content_type == 'page':
                    try:
                        page = self.client.get_page_by_id(content_id, expand='body.storage')
    ...
    def get_document(self, document_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            page = self.client.get_page_by_id(document_id, expand='body.storage,version,space,history,ancestors')
            ...
            document = {
                ...
                "last_updater": page.get('version', {}).get('by', {}).get('displayName', ''),
                "ancestors": ancestors
            }
